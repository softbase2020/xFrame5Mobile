#
#  Be sure to run `pod spec lint xFrame5Mobile.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "hansne"
  # spec.authors            = { "hansne" => "hans@directionsoft.com" }
  # spec.social_media_url   = "https://twitter.com/hansne"
